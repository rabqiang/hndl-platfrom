 ...
 */
@Service
public class StarWeekRankManagerImpl implements StarWeekRankManager {

    @Resource
    private MongoDbService mongoDbService;

    @Override
    public void insertInBatch(List<StarWeekRankDo> starWeekRankDos) {
        mongoDbService.insertInBatch(starWeekRankDos,StarWeekRankDo.class);
    }

    @Override
    public List<StarWeekRankDo> findByRankDate(Long rankTime,Integer limit) {
        ...
        return mongoDbService.findAll(query,StarWeekRankDo.class);
    }
    ...
    public void increaseVote(VoteTypeEnums voteTypeEnums,Long starId, Long voteNum) {
        ...
        mongoDbService.inc(new Query(criteria),update,StarWeekRankDo.class);
    }
    ...
    public void updateImgByStarId(String img, Long starId) {
        ...
        mongoDbService.update(query,map, StarWeekRankDo.class);
    }

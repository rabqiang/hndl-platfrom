...
/**
 * @author 赵俊凯
 * @Description 每天在用户在粉丝会里的统计数据,createTime,userUinId,starId联合唯一索引
 * @Date 2019/4/18 11:51 资龙茂
 * @Created by 湖南达联
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Document(collection = "business_star_fans_day_statistics")
@CompoundIndexes({@CompoundIndex(unique = true,name="fans_day_statistics_index",def = "{userUniId:1,starId:1,createTime:-1}")})
public class StarFansDayStatisticsDo implements Serializable {

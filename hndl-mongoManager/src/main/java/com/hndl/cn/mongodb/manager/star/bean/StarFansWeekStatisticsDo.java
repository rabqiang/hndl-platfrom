...
@NoArgsConstructor
@AllArgsConstructor
@Document(collection = "business_star_fans_week_statistics")
@CompoundIndexes({@CompoundIndex(unique = true,name="fans_week_statistics_index",def = "{userUniId:1,starId:1,createTime:-1}")})
public class StarFansWeekStatisticsDo implements Serializable {

    @Id
    private String id;

    @Indexed
    private Long createTime;//创建时间 周一的初始时间

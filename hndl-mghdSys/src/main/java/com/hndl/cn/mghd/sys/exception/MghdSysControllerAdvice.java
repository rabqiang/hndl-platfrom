...
public class MghdSysControllerAdvice {
    ...
    private static final Logger log = LoggerFactory.getLogger(MghdSysControllerAdvice.class);
    ...
    public Result<Object> classCastExceptionHandler(ClassCastException ex,HttpServletRequest request) {
        MghdSysException weChatSysException = new MghdSysException(PublicExceptionCodeEnum.Ex_PARAM_ERROR.getCode(),ex);
    ...
    public Result<Object> handleException(Exception ex, HttpServletRequest request) {
        MghdSysException weChatSysException = new MghdSysException(PublicExceptionCodeEnum.EX_UNKNOWN.getCode(),ex);
        ExceptionLog.errorPrintStraceAndPath(log, RequestUtil.getErrorMsg(request), weChatSysException);
    ...
    public Result<Object> handleException(NullPointerException ex, HttpServletRequest request) {
        MghdSysException weChatSysException = new MghdSysException(PublicExceptionCodeEnum.EX_OPERATION_FAIL.getCode(), ex);
    ...
    public Result<Object> handleException(HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        MghdSysException weChatSysException = new MghdSysException
        ...
        binder.registerCustomEditor(Date.class, new CustomDateEditor(dateFormat, true) {
            ...
            public void setAsText(String text) {
                try {
                    ...
                    ExceptionLog.error(log, new MghdSysException(PublicExceptionCodeEnum.Ex_PARAM_ERROR.getCode(), ex));
                }
            }
        });
    }

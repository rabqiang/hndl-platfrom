...
@RestController
@ControllerAdvice
public class ActivitySysControllerAdvice {

    private static final Logger log = LoggerFactory.getLogger(ActivitySysControllerAdvice.class);
    ...
    public Result<Object> handleException(Exception ex, HttpServletRequest request) {
        ActivitySysException weChatSysException = new ActivitySysException(PublicExceptionCodeEnum.EX_UNKNOWN.getCode(),ex);
    ...
    public Result<Object> handleException(NullPointerException ex, HttpServletRequest request) {
        ActivitySysException weChatSysException = new ActivitySysException
        ...
        binder.registerCustomEditor(Date.class, new CustomDateEditor(dateFormat, true) {
            ...
            public void setAsText(String text) {
                try {
                    ...
                    ExceptionLog.error(log, new ActivitySysException(PublicExceptionCodeEnum.Ex_PARAM_ERROR.getCode(), ex));
                }
            }
        });
    }

package com.hndl.cn.shop.job.quartz.service;

import com.hndl.cn.base.constants.BaseConstants;
import com.hndl.cn.shop.job.quartz.base.AStandardBaseJob;
import com.hndl.cn.shop.job.quartz.factory.SchedulerJobFactory;
import com.hndl.cn.shop.job.quartz.factory.SchedulerTriggerFactory;
import com.hndl.cn.utils.text.StringBuilderHolder;
...
public class SchedulerJobService {
    ...
    public boolean baseCheck(AStandardBaseJob aTaskStandardJob) {
        ...
        if (aTaskStandardJob.initValidSign() == BaseConstants.VALID_SIGN_N) {

...
@RestController
@ControllerAdvice
public class PaySysControllerAdvice {

    private static final Logger log = LoggerFactory.getLogger(PaySysControllerAdvice.class);
    ...
    public Result<Object> handleException(BaseException ex, HttpServletRequest request) {
        ExceptionLog.errorAndPath(log,RequestUtil.getRequestPath(request),ex);
    ...
    public Result<Object> handleException(Exception ex, HttpServletRequest request) {
        PaySysException weChatSysException = new PaySysException(PublicExceptionCodeEnum.EX_UNKNOWN.getCode(),ex);
    ...
    public Result<Object> handleException(NullPointerException ex, HttpServletRequest request) {
        PaySysException weChatSysException = new PaySysException
        ...
        binder.registerCustomEditor(Date.class, new CustomDateEditor(dateFormat, true) {
            ...
            public void setAsText(String text) {
                try {
                    ...
                    ExceptionLog.error(log, new PaySysException(PublicExceptionCodeEnum.Ex_PARAM_ERROR.getCode(), ex));
                }
            }
        });
    }

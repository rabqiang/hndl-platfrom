...
@RestController
@ControllerAdvice
public class WeChatSysControllerAdvice {

    private static final Logger log = LoggerFactory.getLogger(WeChatSysControllerAdvice.class);
    ...
    public Result<Object> handleException(Exception ex, HttpServletRequest request) {
        WeChatSysException weChatSysException = new WeChatSysException(PublicExceptionCodeEnum.EX_UNKNOWN.getCode(),ex);
        ex.printStackTrace();
    ...
    public Result<Object> handleException(NullPointerException ex, HttpServletRequest request) {
        WeChatSysException weChatSysException = new WeChatSysException
        ...
        binder.registerCustomEditor(Date.class, new CustomDateEditor(dateFormat, true) {
            ...
            public void setAsText(String text) {
                try {
                    ...
                    ExceptionLog.error(log, new WeChatSysException(PublicExceptionCodeEnum.Ex_PARAM_ERROR.getCode(), ex));
                }
            }
        });
    }

package com.hndl.cn.shop.admin.business.resources.controller;

import com.hndl.cn.base.enums.PublicExceptionCodeEnum;
import com.hndl.cn.base.result.Result;

import com.hndl.cn.shop.admin.business.resources.service.ResourcesService;
import com.hndl.cn.shop.admin.business.resources.vo.Base64Vo;
...
//    @ApiImplicitParam(name = "imgFile", value = "图片文件", required = true, paramType = "body", dataType = "file")
    public Result<Object> uploadImg(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        if ((fileSize / 1024) > 10*1024){
            throw new ShopAdminException(PublicExceptionCodeEnum.Ex_FILE_SIZE_MAX_ERROR.getCode());
        }

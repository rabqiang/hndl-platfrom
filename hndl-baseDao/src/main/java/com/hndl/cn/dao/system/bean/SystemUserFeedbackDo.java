 ...
 * @author 
 */
public class SystemUserFeedbackDo implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        SystemUserFeedbackDo other = (SystemUserFeedbackDo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIsTouch() == null ? other.getIsTouch() == null : this.getIsTouch().equals(other.getIsTouch()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsTouch() == null) ? 0 : getIsTouch().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", isTouch=").append(isTouch);

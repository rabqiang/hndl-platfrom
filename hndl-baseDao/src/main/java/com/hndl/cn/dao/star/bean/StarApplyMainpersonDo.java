...
/**
 * star_apply_mainperson
 * @author 
 */
public class StarApplyMainpersonDo implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    /**
     * 审核状态（ing  提交审核中/ok  审核成功/fail  审核失败）
     */
    ...
    public boolean equals(Object that) {
        ...
        StarApplyMainpersonDo other = (StarApplyMainpersonDo) that;

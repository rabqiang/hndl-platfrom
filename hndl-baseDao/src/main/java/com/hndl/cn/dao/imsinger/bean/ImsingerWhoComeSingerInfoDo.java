...
/**
 * imsinger_who_come_singer_info
 * @author 
 */
public class ImsingerWhoComeSingerInfoDo implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        ImsingerWhoComeSingerInfoDo other = (ImsingerWhoComeSingerInfoDo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSingerSex() == null ? other.getSingerSex() == null : this.getSingerSex().equals(other.getSingerSex()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSingerSex() == null) ? 0 : getSingerSex().hashCode());

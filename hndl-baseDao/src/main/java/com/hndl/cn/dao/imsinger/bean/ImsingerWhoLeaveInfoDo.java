...
/**
 * imsinger_who_leave_info
 * @author 
 */
public class ImsingerWhoLeaveInfoDo implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        ImsingerWhoLeaveInfoDo other = (ImsingerWhoLeaveInfoDo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getVoteNumber() == null ? other.getVoteNumber() == null : this.getVoteNumber().equals(other.getVoteNumber()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getVoteNumber() == null) ? 0 : getVoteNumber().hashCode());
        return result;
    }

 ...
 * @author 
 */
public class WelfareGameOrderDo implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public String getPayplatform2cp() {
        return payplatform2cp;
    }

    public void setPayplatform2cp(String payplatform2cp) {
        this.payplatform2cp = payplatform2cp;
    }
    ...
    public boolean equals(Object that) {
        ...
        WelfareGameOrderDo other = (WelfareGameOrderDo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPayplatform2cp() == null ? other.getPayplatform2cp() == null : this.getPayplatform2cp().equals(other.getPayplatform2cp()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPayplatform2cp() == null) ? 0 : getPayplatform2cp().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", payplatform2cp=").append(payplatform2cp);

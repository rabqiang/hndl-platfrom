 ...
 * @author 
 */
public class CommonPromiseInfoDo implements Serializable {
    /**
     * ä¸»é”®
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        CommonPromiseInfoDo other = (CommonPromiseInfoDo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPromiseDesc() == null ? other.getPromiseDesc() == null : this.getPromiseDesc().equals(other.getPromiseDesc()))
            && (this.getStage() == null ? other.getStage() == null : this.getStage().equals(other.getStage()))
            && (this.getIsReach() == null ? other.getIsReach() == null : this.getIsReach().equals(other.getIsReach()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPromiseDesc() == null) ? 0 : getPromiseDesc().hashCode());
        result = prime * result + ((getStage() == null) ? 0 : getStage().hashCode());
        result = prime * result + ((getIsReach() == null) ? 0 : getIsReach().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", promiseDesc=").append(promiseDesc);

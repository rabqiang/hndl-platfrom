...
/**
 * common_user_get_prize_info
 * @author 
 */
public class CommonUserGetPrizeInfoDo implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        CommonUserGetPrizeInfoDo other = (CommonUserGetPrizeInfoDo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIfReceive() == null ? other.getIfReceive() == null : this.getIfReceive().equals(other.getIfReceive()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIfReceive() == null) ? 0 : getIfReceive().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", ifReceive=").append(ifReceive);

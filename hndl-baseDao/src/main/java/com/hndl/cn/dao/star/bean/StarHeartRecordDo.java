 ...
 * @author 
 */
public class StarHeartRecordDo implements Serializable {
    /**
     * 主键
     */
    private Long id;
    ...
    public String getMeTradeId() {
        return meTradeId;
    }

    public void setMeTradeId(String meTradeId) {
        this.meTradeId = meTradeId;
    }
    ...
    public boolean equals(Object that) {
        ...
        StarHeartRecordDo other = (StarHeartRecordDo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getMeTradeId() == null ? other.getMeTradeId() == null : this.getMeTradeId().equals(other.getMeTradeId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getMeTradeId() == null) ? 0 : getMeTradeId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", meTradeId=").append(meTradeId);

...
@RestController
@ControllerAdvice
public class VersionSysControllerAdvice {

    private static final Logger log = LoggerFactory.getLogger(VersionSysControllerAdvice.class);
    ...
    public Result<Object> handleException(Exception ex, HttpServletRequest request) {
        VersionSysException weChatSysException = new VersionSysException(PublicExceptionCodeEnum.EX_UNKNOWN.getCode(),ex);
    ...
    public Result<Object> handleException(NullPointerException ex, HttpServletRequest request) {
        VersionSysException weChatSysException = new VersionSysException
        ...
        binder.registerCustomEditor(Date.class, new CustomDateEditor(dateFormat, true) {
            ...
            public void setAsText(String text) {
                try {
                    ...
                    ExceptionLog.error(log, new VersionSysException(PublicExceptionCodeEnum.Ex_PARAM_ERROR.getCode(), ex));
                }
            }
        });
    }

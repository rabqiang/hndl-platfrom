...
import com.hndl.cn.mghd.admin.shiro.MghdAdminRealm;
...
//    @Resource
//    private MghdAdminUserFilter mghdAdminUserFilter;
...
//        filtersMap.put("userFilter", mghdAdminUserFilter);
...
//        filterChainDefinitionMap.put("/my-swagger-ui.html", "anon");
    ...
    public SecurityManager securityManager(){
        ...
        securityManager.setRealm(mghdAdminRealm());
        securityManager.setRememberMeManager(cookieRememberMeManager());
        return securityManager;
    }

    @Bean
    public MghdAdminRealm mghdAdminRealm(){
        MghdAdminRealm mghdAdminRealm = new MghdAdminRealm();
        mghdAdminRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        mghdAdminRealm.setCachingEnabled(false);
        return mghdAdminRealm;
    }
...
//        Collection<SessionListener> listeners = new ArrayList<SessionListener>();
        //配置监听
//        listeners.add(adminSessionListener);
//        sessionManager.setSessionListeners(listeners);
        sessionManager.setSessionIdUrlRewritingEnabled(true);
        sessionManager.setGlobalSessionTimeout(MgdAdminConstants.DEFAULT_SESSION_TIME_OUT);
